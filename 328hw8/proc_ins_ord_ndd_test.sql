/*=====
    testing script for function proc_ins_ord_ndd
...
prompt
prompt *********************************
prompt TESTING proc_ins_ord_ndd
prompt *********************************
prompt
...
exec proc_ins_ord_ndd('9780201122305', 50)

prompt
prompt =============================================================
prompt test 1 passes if 
prompt
...
exec proc_ins_ord_ndd('9780805343021', 5)

prompt =============================================================
prompt test 2 passes if 
prompt
...
exec proc_ins_ord_ndd('9780805343021', 10)

prompt =============================================================
prompt test 3 passes if 
prompt
prompt     there are still ONLY FOUR order_needed rows for 9780805343021,
...
exec proc_ins_ord_ndd('1111111111111', 11)

prompt =============================================================
prompt test 5 passes if
prompt
...
-- end of proc_ins_ord_ndd_test.sql
